...
def setup_training(self):
    ...
    if self.train and os.path.isfile("my-saved-model_ohne_batchnorm_neuer_reward5.pt"):
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    # Store the model
    with open("my-saved-model_ohne_batchnorm_neuer_reward5.pt", "wb") as file:
